...
const Menu = ({ themes }) => (
    <div>
        ...
        <nav className="navbar navbar-expand-lg navbar-primary" style={{ marginBottom: 0 }}>
            ...
            <button className="navbar-toggler navbar-dark mt-3 btn btn-outline-info" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
